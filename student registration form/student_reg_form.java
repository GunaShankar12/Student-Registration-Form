...
public class student_reg_form extends JFrame implements ActionListener
{
    JLabel message;
...
// gpa textfield
 gpa = new JTextArea();
// gpa textfield end
        image1=new ImageIcon("C:\\Users\\91709\\Documents\\java\\background1.jpg");
        bg = new JLabel(image1);
        bg.setSize(1700,1080);
        panel = new JPanel();
        image2 = new ImageIcon("C:\\Users\\91709\\Documents\\java\\anits22.jpg");
...
catch(Exception ae)
{
  ...
  public static void main(String[] args)
    {
        student_reg_form frame = new student_reg_form();
